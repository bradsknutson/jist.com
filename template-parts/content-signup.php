<?php 
    if ( get_field( 'slice_content', 92 ) ) { 
        $content = get_field( 'slice_content', 92 );
        $btn_text = get_field( 'button_text', 92 );
        $btn_action = get_field( 'button_action', 92 );
        $btn_link = get_field( 'button_link', 92 );
        $id = get_field( 'modal_form_id', 92 );
?>
