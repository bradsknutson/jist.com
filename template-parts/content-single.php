                        ...
                        <div class="col-md-8">
                            ...
                            <div class="social-icons">
                                ...
                                <i class="fa fa-twitter" aria-hidden="true">
                                    <a href="https://twitter.com/share?url=<?php echo esc_url( get_permalink() ); ?>&via=JIST_Solutions&text=<?php echo get_the_title(); ?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;" target="_blank" title="Share on Twitter"></a>
                                </i>
